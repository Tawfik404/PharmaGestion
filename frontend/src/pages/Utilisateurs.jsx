...
const rolePermissions = {
  ...
  caissier: ['Tableau de bord', 'Point de Vente', 'Clients','Rapports (ventes)'],
  pharmacien: ['Tableau de bord', 'Medicaments', 'Stock', 'Ordonnances', 'Clients', 'Fournisseurs', 'Rapports (Stock et Medicaments)'],
}
